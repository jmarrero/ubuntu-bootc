THIS IS BROKEN still, dont use it!
...
-v /dev:/dev   -v /tmp/bootc-storage:/var/lib/containers \
 ...
 ghcr.io/jmarrero/ubuntu-bootc:latest \
  ...
  --source-imgref docker://ghcr.io/bootcrew/ubuntu-bootc:latest   --root-ssh-authorized-keys /id_rsa.pub   --composefs-backend --wipe --filesystem ext4 --bootloader systemd   /dev/vda
```

This boots!! But no Network/DHCP yet... which means no ssh access yet...
